...
// ── Paleta de colores de AutoCita ──────────────────────────────────────────

// Azul primario — usado para botones, headers y elementos principales
val AzulPrimario = Color(0xFF1565C0)
val AzulClaro = Color(0xFF5E92F3)
val AzulOscuro = Color(0xFF003C8F)

// Naranja secundario — usado para acentos y elementos secundarios
